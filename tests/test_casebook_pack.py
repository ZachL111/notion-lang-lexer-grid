"""Regression checks for the notion-lang-lexer-grid casebook."""
...
from casebook.harness import assert_expected, notion_lang_lexer_grid_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(notion_lang_lexer_grid_summary(), assert_expected())
